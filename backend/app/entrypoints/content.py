"""The content domain's entrypoint.

Posts, categories and the site-content singleton: 14 routes under `/api/v1`.

Run by the image as `python -m app.entrypoints.content`. There is no Lambda
